...
- **API layer**: Follow existing patterns for how features are structured
...
4. **Follow existing patterns** — review how similar features are implemented before adding new ones
